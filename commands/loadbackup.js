...
exports.run = async (client, message, args) => {
    ...
    backup.fetch(backupID).then(() => {
        ...
        message.channel.send(':warning: All the server channels, roles, and settings will be cleared. Do you want to continue?\n\n the server backup contains message , roles, server icon, everything presents in that server \n\nSend `confirm` or `cancel`!');
